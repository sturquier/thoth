...
Future<bool> crawlNetflixTechBlog(List<Article> existingArticles) async {
  final List<Article> articles = [];
  final Website website = websites.firstWhere(
      (Website website) => website.name == EWebsite.netflixTechBlog.name);
  ...
  if (response.statusCode == 200) {
    ...
    final Element? postsSection =
        document.getElementsByTagName('section').isNotEmpty
            ? document.getElementsByTagName('section')[3]
            : null;
